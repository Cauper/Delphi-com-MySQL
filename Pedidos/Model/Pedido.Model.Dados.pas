...
uses FireDAC.Phys.MySQLDef, FireDAC.Stan.Intf, FireDAC.Stan.Option,
  ...
  System.Classes, System.IniFiles, System.SysUtils, Vcl.Dialogs, Vcl.Forms;
    ...
    try
      ...
      begin
        ...
        if ini.ReadString('Banco de Dados', 'VendorLib', '') <> '' then
            FDPhysMySQLDriverLink.VendorLib := UTF8Decode(ini.ReadString('Banco de Dados', 'VendorLib', ''));
      end;
